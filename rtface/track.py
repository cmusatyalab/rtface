...
class concurrentManager(object):
    ...
    def c_init(self, imgs, init_bxes):
        ...
        print
        'total startup took :{}'.format((time.time() - start))
        return ret
    ...
    def c_track(self, imgs):
        ...
        for i in range(0, len(self.c_workers)):
            ret.append(self.c_output_queues[i][0].recv())
        print
        'c_track took :{}'.format((time.time() - start))
        return ret
    ...
    def run(self):
        ...
        while True:
            ...
            if updates[0] == 'init':
                ...
                ret = 'success'
                print
                'c_worker process created: {}'.format(self.idx)
                ...
                print
                'c_worker process killed: {}'.format(self.idx)
                break
...
if __name__ == "__main__":
    ...
    for img in imgs[1:]:
        ...
        idx += 1
        print
        'tracking time: {:0.3f}'.format((time.time() - s))
    worker.clean()
